...
function generateTable(data) {
  ...
  $.each(data, function (key, value) {
    ...
    if (id == 7) {
      ...
      table += "<button class='btn approve-btn' data-bs-toggle='modal' data-bs-target='#reviewModalCenter'>Approve</button></td>";
    } else {
      table += "Approved</td>";
    }
    table += "<td>" + '<a href="personal_leave_letter.pdf" download><i class="bi bi-file-earmark-arrow-down m-0"></i> <span class="clickable-text">Download</span></a>' + "</td>" + "</tr>";
