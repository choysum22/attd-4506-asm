...
function renderSchool() {
  $.getJSON("js/json/school_attendance.json", function (data) {
    var table = "";
    var color = "";
...
function renderClass() {
  $.getJSON("js/json/class_attendance_year.json", function (data) {
    var table = "";
    var color = "";
    $.each(data, function (key, value) {
      color = colorAttendance(value.attendance_rate);
...
function renderStudent() {
  $.getJSON("js/json/student_attendance.json", function (data) {
    var table = "";
    var color = "";
    $.each(data, function (key, value) {
      color = colorAttendance(value.attendance_rate);
